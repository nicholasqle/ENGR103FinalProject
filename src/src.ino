...
int arraySize, wrongGuesses, currentReading, score, touchedPad;
bool gameRunning, padTouched;
bool ResetFlag=0;
bool FinishFlag=0;
const byte interruptButtonLeft = 4;
const byte interruptButtonRight = 5;
int pads[] = {6, 9, 10, 3, 2, 0, 1}; //Converts analog pin number to digital pin for A1 to A7.
int numbers[10];
//The below speech was pulled from the Talk_US_Clock Speech_Demos. The original credits are as follows:
// Talkie library
